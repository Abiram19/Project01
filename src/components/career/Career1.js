                ...
                <div className='col-md-6 mb-5'>
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <Link to="/course" className="btn btn-danger">Read more</Link>
                        </div>
                    </div>
                </div>
                <div className='col-md-6 mb-5'>
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <Link to="/careerlife" className="btn btn-danger">Read more</Link>
                        </div>
                    </div>
                </div>
                <div className='col-md-6 mb-5'>
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <Link to="/careerjob" className="btn btn-danger">Read more</Link>
                        </div>
                    </div>
                </div>
                <div className='col-md-6 mb-5'>
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <Link to="/careerpeople" className="btn btn-danger">Read more</Link>
                        </div>
                    </div>
                </div>
            </div>
